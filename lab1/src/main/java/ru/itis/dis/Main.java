...
public class Main {
    ...
    private static void processFiles() {
        ...
        Thread thread3 = new Thread(new CorrelationRunnable(data,
                ticket -> ticket.getCloseY()*ticket.getCloseX(),
                xyCorrelationResult)
        );
        thread1.start();
        thread2.start();
        ...
        try {
            ...
            logger = new Logger(new DataError(DataError.ERROR,
                    "Threads were interrupted: "+e.getLocalizedMessage()),
